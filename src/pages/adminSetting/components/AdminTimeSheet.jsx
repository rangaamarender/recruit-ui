...
function AdminTimeSheet() {
    ...
    const onSubmit = (data) => {
        const apiPayLoad = {
            ...
            expiryInd: data.checkbox3,
            monitorable: data.checkbox4,
        ...
        <>
            ...
            >
                <div className="w-75 fixed overflow-hidden h-custom-10 top-0">
                    <TitleHeaderOnly title="Timesheet Document Definition" onClick={toggleSidebar} />
                </div>
            ...
            >
                <div className="w-75 fixed overflow-hidden h-custom-10 top-0">
                    <TitleHeaderOnly title="Timesheet Document Definitions" onClick={handleCancel} />
                </div>
                    ...
                    <form>
                        ...
                        <form>
                            <div className="flex justify-content-between align-items-center border-bottom p-1">
                                <div className="fs-5 fw-bold">Timesheet Attribution Definitions</div>
                                <Button
